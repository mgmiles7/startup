...
- [X] **Supports registration, login, logout, and restricted endpoint** - Uses cookies and unique ids to support registration, login, and logout. Use those cookies for restricted endpoints throughout the app
